    ...
    (new function() {
        ...
        this.init = function() {
            ...
            t.default(".pp-g-recaptcha").each((function(s, a) {
                var r = t.default(a).attr("data-sitekey"),
                    o = t.default(this).parents(".pp-form-container").find("form");
                if ("v3" === t.default(a).attr("data-type")) o.find("input.pp-submit-form").on("click", (function(s) {
                    s.preventDefault(), e._add_processing_label(o), grecaptcha.ready((function() {
                        grecaptcha.execute(r, {
                            action: "form"
                        }).then((function(e) {
                            o.find('[name="g-recaptcha-response"]').remove(), o.append(t.default("<input>", {
                                type: "hidden",
                                value: e,
                    ...
                    o.on("pp_form_submitted", (function() {
                        grecaptcha.reset(p)
                    })), t.default(document).on("ppress_process_checkout_success_callback ppress_process_checkout_error_callback", (function() {
                        grecaptcha.reset(p)
                    }))
                }
            }))
            ...
            e._remove_status_notice(), a.parents(".pp-tab-widget-form").prev(".pp-tab-status").remove(), e._add_processing_label(a), t.default.post(pp_ajax_form.ajaxurl, p, (function(s) {
                if (a.trigger("pp_form_submitted"), "object" != typeof s) return e._remove_processing_label(a);
                if ("message" in s) {
                    if (a.trigger("pp_password_reset_status"), o) {
            ...
            if (void 0 !== window.FormData && window.FormData) {
                ...
                o.append("action", "pp_ajax_signup"), o.append("melange_id", r), e._remove_status_notice(), a.parents(".pp-tab-widget-form").prev(".pp-tab-status").remove(), e._add_processing_label(a), t.default.post({
                    url: pp_ajax_form.ajaxurl,
                    data: o,
                    cache: !1,
                    contentType: !1,
                    ...
                    success: function(t) {
                        ...
                        if ("message" in t)
                            if (a.trigger("pp_registration_error", [t]), a.trigger("pp_registration_ajax_response", [t]), p) {
            ...
            e._remove_status_notice(), e._add_processing_label(a), t.default.post(pp_ajax_form.ajaxurl, r, (function(t) {
                ...
                else if (a.trigger("pp_login_form_error"), "code" in t && "pp2fa_auth_code_invalid" == t.code && a.find(".pp-2fa").show(), o) {
        ...
        window.ppressCheckoutForm = this, this.init = function() {
            ...
            t.default.post(pp_ajax_form.ajaxurl, s, (function(a) {
                ...
                let o, p = t.default(".ppress-checkout_order_summary__bottom_details");
                (o = t.default(".ppress-checkout-alert")).length > 0 && (p = o), e.scroll_to_notices(p), e.remove_spinner()
            }))
                ...
                if (!1 !== a.triggerHandler("ppress_checkout_place_order_" + r)) {
                    ...
                    s.append("action", "ppress_process_checkout"), s.append("ppress_checkout_nonce", t.default("#ppress_checkout_nonce").val()), t.default.post({
                        ...
                        error: function(s, a, r) {
                            t.default(document.body).trigger("ppress_process_checkout_error_callback", [s, a, r]), e.createAlertMessage(r)
                        }
                    }, "json")
                }
            }
