    ...
    o.m = n, o.d = function(e, t) {
        ...
        function() {
            ...
            var v = h((function e() {
                    ...
                    }(this, e), this.message = t, this.props = n, this.error = Error(this.message), this.isUserError = r, this.fingerprint = this.message
                })),
                b = {},
                m = {},
                w = {};
            ...
            var O = function() {
                function e(t, n) {
                    ! function(e, t) {
                        if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                    }(this, e), this.name = t.name, this.id = t.id, this.features = t.features, this.bootstrap = t.bootstrap, this.win = n, this.doc = n.document
                }
                var t, n;
                return t = e, n = [{
                    key: "ready",
                        ...
                        return new l((function(t, n) {
                            e.createIframeElement().then((function(r) {
                                r.addEventListener("load", (function() {
                                    ...
                                    o && o.document ? (o.ACFetch = d, t(o.document)) : n(e.error())
                    ...
                    value: function(e, t) {
                        ...
                        e && (e.zendesk = (n = {}, r = this.name, o = {
                            ...
                            configurable: !0,
                            writable: !0
                        }) : n[r] = o, n), Object && Object.freeze && this.deepFreeze(e.zendesk), e.zEQueue = t)
                    }
                }, {
                    key: "deepFreeze",
                    value: function(e) {
                        var t = this;
                        return Object.freeze(e), void 0 === e || Object.getOwnPropertyNames(e).forEach((function(n) {
                            null === e[n] || "object" !== g(e[n]) && "function" != typeof e[n] || Object.isFrozen(e[n]) || t.deepFreeze(e[n])
                        })), e
                    }
                }, {
                    key: "injectAssets",
                ...
                }], n && j(t.prototype, n), Object.defineProperty(t, "prototype", {
                    writable: !1
                }), e
            }();
            ...
            var E = function() {
                    function e(t, n) {
                        ! function(e, t) {
                            if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                        }(this, e), this.product = t, this.productIframe = new O(this.product, n)
                    }
                    var t, n;
                    return t = e, n = [{
                        key: "getProductAssets",
                        value: function() {
                            return arguments.length > 0 && void 0 !== arguments[0] && arguments[0] ? w[this.product.name].assets : this.product.assets
                        }
                    }, {
                        key: "load",
                        value: function(e, t) {
            ...
            var S = function() {
                ...
                return t = e, n = [{
                    ...
                    value: function(e) {
                        return new l((function(t, n) {
                            try {
                                (0, k.loadScript)(e.zopimSrc), t()
                            } catch (e) {
                                n(e)
                            }
                        }))
                    }
                }], n && _(t.prototype, n), Object.defineProperty(t, "prototype", {
                    writable: !1
                }), e
            }();
            ...
            var T = "__zE_ac_version",
                R = function() {
                    ...
                    return t = e, (n = [{
                        ...
                        value: function() {
                            return "".concat(T, "=").concat(this.version.name, "/").concat(this.version.string)
                        }
                    }, {
                        key: "getVersion",
                        value: function(e) {
                            ...
                            var n = (0, k.parseUrlParams)(e.location.href)[T] || t;
                            if (n) {
                                var r = n.split("/");
                    ...
                    }]) && z(t.prototype, n), Object.defineProperty(t, "prototype", {
                        writable: !1
                    }), e
                }();
                ...
                return t = e, n = [{
                    ...
                    value: function(e) {
                        ...
                        return new l((function(r, o) {
                            ...
                            if (n) i.zEACLoaded = !0, i.$zopim ? r(m.products) : r(b.products);
                            else {
                                var u = new R(i, e),
                                    c = function(e) {
                                        var t = e.products;
                                ...
                                d(a).then(c).catch((function(n) {
                                    404 !== n.status && 400 !== n.status ? d(a).then((function(e) {
                                        return c(e)
                                    })).catch((function() {
                                        return o(t.error(e))
                                    })) : o(t.error(e))
                    ...
                    value: function(e) {
                        ...
                        return e.map((function(e) {
                            return "zopim_chat" === e.name ? new S(e.id, t) : new E(e, t)
                        }))
                    }
                }, {
                    key: "error",
                ...
                return t = u, n = [{
                    ...
                    value: function() {
                        ...
                        return new l((function(t, n) {
                            ...
                            return r ? e._isHostMapped(r) ? d("https://".concat(r, "/embeddable/zendesk_host")).then((function(e) {
                ...
                return t = c, n = [{
                    ...
                    value: function() {
                        ...
                        return new l((function(t, n) {
                            ...
                            if (r) {
                                var o = (0, k.parseUrlParams)(r.src);
            ...
            var q = function(e) {
                ...
                return t = c, n = [{
                    ...
                    value: function() {
                        var e = this;
                        return new l((function(t, n) {
                            var r = (0, k.getQueryParamsString)(c.getScriptSrc(e.win));
            ...
            var Y = null,
                ee = {
                    ...
                    dsn: void 0,
                    environment: void 0,
                    release: "asset-composer@v59",
                    sampleRate: 1,
                    defaultIntegrations: !1
                },
                te = function() {
                    return new l((function(e) {
                        Y ? e(Y) : o.e(996).then(o.bind(o, 858)).then((function(t) {
                            var n = t.BrowserClient,
                                r = t.makeFetchTransport,
                                o = t.defaultStackParser,
                                i = t.Hub,
                                u = t.Integrations,
                                c = new n(G(G({}, ee), {}, {
                                    integrations: [new u.InboundFilters, new u.FunctionToString, new u.HttpContext],
                                    transport: r,
                                    stackParser: o
                                }));
                            Y = new i(c), e(Y)
            ...
            function ne(e) {
                return e && e instanceof v ? te().then((function(t) {
                ...
                try {
                    ...
                    var t = function(e) {
                            return W.isSnippetPresent(e) ? new W(e) : e.document.zendeskHost && e.document.zEQueue ? new L(e) : q.isSnippetPresent(e) ? new q(e) : new W(e)
                        }(window),
                        n = new x(t);
